...
**Tracking.** At this time, we do not track users across apps and websites owned by other companies. We do not use the Identifier for Advertisers (IDFA) or share data across other companies' apps for advertising purposes. We only track user activity within our own app for service delivery and analytics purposes.

We collect email addresses for our own communication purposes and track user activity inside our own app only. If we begin tracking across apps in the future, we will update this Privacy Policy and comply with applicable tracking disclosure requirements.
